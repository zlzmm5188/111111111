...
@Module({
  ...
  controllers: [AdminController, AdminV2Controller, HoldingManagementController],
  providers: [AdminService, HoldingManagementService, ExchangeRecordService, OperationLogService],
