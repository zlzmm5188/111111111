...
export class Post {
  ...
  @Column({ type: 'varchar', length: 20, nullable: true, name: 'media_type', comment: '媒体类型: text=纯文字, image=图片, video=视频' })
  mediaType: string;

  @Column({ type: 'varchar', length: 500, nullable: true, name: 'video_url', comment: '视频URL' })
  videoUrl: string;
