const homePageRoutes = [
  ...
  // AGX 邀请管理
  {
    name: 'agxInvites',
    path: '/agx/invites',
    component: () => import('@/views/agx/inviteChain.vue'),
  ...
  // AGX 发帖条件配置
  {
    name: 'agxPostCondition',
    path: '/agx/postCondition',
    component: () => import('@/views/agx/postCondition.vue'),
    meta: { title: '发帖条件配置', hidden: true }
  },
  // AGX 社交管理
  {
    name: 'agxSocialManage',
    path: '/agx/socialManage',
    component: () => import('@/views/agx/socialManage.vue'),
    meta: { title: '社交管理', hidden: true }
  },
  // AGX 官方帖子管理
  {
    name: 'agxOfficialPost',
    path: '/agx/officialPost',
    component: () => import('@/views/agx/officialPost.vue'),
    meta: { title: '官方内容管理', hidden: true }
  },
  // AGX 用户帖子管理
  {
    name: 'agxUserPost',
    path: '/agx/userPost',
    component: () => import('@/views/agx/userPost.vue'),
    meta: { title: '用户内容管理', hidden: true }
  },
  // AGX 话题管理
  {
    name: 'agxTopics',
    path: '/agx/topics',
    component: () => import('@/views/agx/topics.vue'),
    meta: { title: '话题管理', hidden: true }
  },
  // AGX 新闻采集管理
  {
    name: 'agxNewsCrawler',
    path: '/agx/newsCrawler',
    component: () => import('@/views/agx/newsCrawler.vue'),
    meta: { title: '新闻采集', hidden: true }
  },
  // AGX 管理员管理
  {
    name: 'agxAdmins',
    path: '/agx/admins',
    component: () => import('@/views/agx/admins.vue'),
