...
<template>
  <a-layout-content class="flex flex-col lg:h-full relative w-full">
    ...
    <div class="_crud-content">
      <div class="operation-tools lg:flex justify-between mb-2" ref="crudOperationRef">
    ...
    <div class="_crud-footer mt-2 text-right" ref="crudFooterRef" v-if="total > 0 && openPagination && !options.tablePagination">
      <a-pagination
        :total="total"
