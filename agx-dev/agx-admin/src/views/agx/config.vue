      ...
      <a-tab-pane key="agx" title="AGX配置">
        <a-card :bordered="false">
          <a-form :model="agxConfig" layout="vertical">
            <a-row :gutter="16">
              <a-col :span="8">
                <a-form-item label="AGX认购价格(USDT)">
                  <a-input-number 
                  ...
                  />
                  <template #extra>
                    <span class="form-tip">前台AGX申购页面显示的认购价格</span>
                  </template>
                </a-form-item>
              </a-col>
              <a-col :span="8">
                <a-form-item label="AGX最小认购数量">
                  <a-input-number 
            ...
            <a-row :gutter="16">
              <a-col :span="8">
                <a-form-item label="认购开关">
                  ...
                  />
                  <template #extra>
                    <span class="form-tip">是否开启AGX认购功能</span>
                  </template>
                </a-form-item>
              </a-col>
            </a-row>
          ...
          <a-col :span="24">
            <a-space>
              <a-select v-model="searchForm.group" placeholder="配置组" allow-clear style="width: 150px">
                ...
                <a-option value="agx">AGX配置</a-option>
              </a-select>
