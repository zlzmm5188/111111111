...
.rank-badge {
  ...
  align-items: center;
  justify-content: center;
  background: linear-gradient(135deg, var(--color-rank-silver, #C0C0C0), var(--color-rank-silver-dark, #808080));
  border: 2px solid var(--bg-elevated, #181a20);
  border-radius: 50%;
  font-size: 11px;
  font-weight: 700;
  color: #fff;
...
.rank-badge.gold {
  background: linear-gradient(135deg, var(--color-rank-gold, #FFD700), var(--color-rank-gold-dark, #FFA500));
  color: #0f1317;
}
...
.my-rank-card {
  ...
  align-items: center;
  padding: 16px;
  background: linear-gradient(135deg, rgba(201,169,98,0.1), var(--bg-elevated-alt, #1e2329));
