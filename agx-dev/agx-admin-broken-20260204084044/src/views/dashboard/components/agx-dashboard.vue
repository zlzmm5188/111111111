...
// 快捷入口
const quickEntries = [
  { label: 'KYC审核', path: '/kyc', icon: IconSafe, bgColor: 'rgba(250, 173, 20, 0.1)', color: '#FAAD14' },
  { label: '提现审核', path: '/withdraw', icon: IconSwap, bgColor: 'rgba(245, 34, 45, 0.1)', color: '#F5222D' },
  { label: '充值记录', path: '/recharge', icon: IconMoney, bgColor: 'rgba(82, 196, 26, 0.1)', color: '#52C41A' },
  { label: '资产流水', path: '/asset-logs', icon: IconFile, bgColor: 'rgba(78, 89, 105, 0.1)', color: '#4E5969' },
  { label: '用户查询', path: '/users', icon: IconUserGroup, bgColor: 'rgba(24, 144, 255, 0.1)', color: '#1890FF' },
  { label: '公告管理', path: '/notice', icon: IconSettings, bgColor: 'rgba(134, 144, 156, 0.1)', color: '#86909C' },
]
