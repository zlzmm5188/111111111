...
<template>
  <a-layout class="layout flex flex-col h-full">
    <a-layout-header class="ma-ui-header flex justify-between h-50 layout-banner-header operation-area">
      <div class="flex justify-between md:justify-center logo items-center">
        <img :src="`${$url}agx-logo.png`" class="mt-1 ml-2 md:ml-0 rounded" style="width: 28px; height: 28px;" />
        <span class="ml-2 text-xl font-bold hidden md:block" style="color: #d4af37;">AGX</span>
      </div>
