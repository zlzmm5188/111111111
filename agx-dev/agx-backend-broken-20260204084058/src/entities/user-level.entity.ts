...
export class UserLevel {
  ...
  @Column({ type: 'varchar', length: 50, comment: '等级名称: 普通用户, 准入会员, 优选会员, 资本合伙人, 执行官合伙人, 主权合伙人' })
  name: string;
  ...
  @Column({ type: 'decimal', precision: 5, scale: 4, name: 'pool_bonus', default: '0.00', comment: '矿池额外奖励比例: 0.05=5%' })
  poolBonus: string;
