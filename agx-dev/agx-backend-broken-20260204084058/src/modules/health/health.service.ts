...
export class HealthService {
  ...
  async logSystemMetrics() {
    ...
    this.logger.log(`[System Metrics] Users: ${metrics.database.users}, Orders: ${metrics.database.orders}, Memory: ${((metrics.server.memory.heapUsed || 0) / 1024 / 1024).toFixed(2)} MB, Uptime: ${(metrics.server.uptime / 3600).toFixed(2)} hours`);
  }
}
